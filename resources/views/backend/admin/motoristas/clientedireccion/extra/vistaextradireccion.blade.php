...
@section('archivos-js')
    ...
    <script type="text/javascript">
        $(document).ready(function(){
            var id = {{ $id }};
            var ruta = "{{ URL::to('/admin/motorista/direccion-extra/tabla') }}/" + id;
    ...
    <script>
        ...
        function nuevo(){
            ...
            axios.post('/admin/motorista/direccion-extra/nuevo', formData, {
            })
                .then((response) => {
                    closeLoading();
        ...
        function informacion(id){
            ...
            axios.post('/admin/motorista/direccion-extra/informacion',{
                'id': id
            })
                .then((response) => {
                    closeLoading();
        ...
        function editar(){
            ...
            axios.post('/admin/motorista/direccion-extra/editar', formData, {
            })
                .then((response) => {
                    closeLoading();
                    if (response.data.success === 1) {
        ...
        function borrarDireccion(id){
            ...
            var formData = new FormData();
            formData.append('id', id);
            axios.post('/admin/motorista/direccion-extra/borrar', formData, {
            })
                .then((response) => {
                    closeLoading();
                    if (response.data.success === 1) {
